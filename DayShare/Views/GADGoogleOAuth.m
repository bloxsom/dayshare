...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.frame = CGRectOffset(frame, 0, 44 + 20);
    }
    return self;
}
...
-(void)showWebviewForUserLogin{
    ...
    [[_parentView layer] addAnimation:applicationLoadViewIn forKey:kCATransitionFromBottom];
